let access_exists, crystal, debug, detail_types, fs, merge, pluralize, process, processModel;
...
processModel = (model_name, spec) => {
	let access, detail, detail_gen, detail_name, detail_options, i, model, model_gen, role, role_data;
