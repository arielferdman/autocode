let cson, fs, init, load, loadSrc, path, setNestedPropertyValue, skeemas, xml, yaml
...
init = function(project_path, validate) {
	let autocode_config, autocode_path, config, config_schema
	if (validate == null) {
		validate = true
	}
